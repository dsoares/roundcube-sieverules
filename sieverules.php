		...
		if ($rcmail->task == 'mail') {
			if (($rcmail->action == '' || $rcmail->action == 'show') && ($shortcut = $rcmail->config->get('sieverules_shortcut', 0)) > 0) {
				...
				if ($shortcut == 1) {
					...
					$button = $this->api->output->button(array('command' => 'plugin.sieverules.create', 'label' => 'sieverules.createfilter', 'type' => 'link', 'class' => 'icon sieverules filterlink', 'classact' => 'icon sieverules filterlink active', 'innerclass' => 'icon sieverules'));
